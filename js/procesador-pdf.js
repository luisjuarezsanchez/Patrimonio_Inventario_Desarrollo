...
function generarDetallePDF(idDeFicha){
    $.get('http://creadoresedomex.com.mx/patrimonio/obtenerFichasDetalladas.php?fichas=["' +  idDeFicha + '"]', function( data ) {
...
function addIntro(doc, archivos, museo, id, usuario, status){
    if(archivos != null && archivos.length > 0){
        ...
        if(archivos[0].endsWith("jpg") || archivos[0].endsWith("jpeg") || archivos[0].endsWith("png"))
            requestFile("http://creadoresedomex.com.mx/patrimonio/" + archivos[0], insertarImagen, doc);
        else if(archivos[0].endsWith("pdf"))
            requestFile("http://creadoresedomex.com.mx/patrimonio/images/thumbs_PDF.jpg", insertarImagen, doc);
        else if(archivos[0].endsWith("mp4") || archivos[0].endsWith("avi") || archivos[0].endsWith("3gp"))
            requestFile("http://creadoresedomex.com.mx/patrimonio/images/video_icon.png", insertarImagen, doc);
...
function printLeftContent(doc, archivos, procedencia, medidas, medidasBase){
    ...
    if(archivos != null)
        for(var i = 0 ; i < archivos.length ; i++){
            requestFile("http://creadoresedomex.com.mx/patrimonio/" + archivos[i], populateMultimediaSection, doc, i);
        }
